        ...
        <table >
            ...
            <form action="Update.php" method="POST" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td colspan='5'>
                        EIDN:  <input type="text" name="eid" value='<?php echo $eid; ?>' > 
                    </td>
                </tr>
                <tr>
                    <td>Date Hired: <input type="date" name="date_hired" value='<?php echo $date_hired; ?>' > </td>
                    <td> Department:  
                       <input type="text" name="department" value='<?php echo $department; ?>' >
                    </td>
                    <td> Position:  <input type="text" name="position" id="position" class="form-control" value='<?php echo $position; ?>' ></td>
                    <td> Employee Status: 
                ...
                <tr>
                    ...
                    <a href="edit_pic.php?id=<?php echo $emp_id; ?>"  style="background-color:green;padding:5px 15px;z-index:99;position:static;border-radius:5px;color:floralwhite;">Change Picture</a>  
                    </td>
                ...
                <tr colspan="3">
                    <td> Family Name </td>
                    <td colspan="2"> <input type="text" name="family_name" value='<?php echo $family_name; ?>' ></td>
                </tr>
                <tr >
                    <td> First Name </td>
                    <td colspan="2"> <input type="text" name="first_name" value='<?php echo $first_name; ?>'  ></td>
                </tr>
                <tr >
                    <td> Middle Name </td>
                    <td colspan="2"> <input type="text" name="middle_name" value='<?php echo $middle_name; ?>'  ></td>
                </tr>
                <tr >
                    <td>Contact Number</td>
                    <td colspan="2"> <input type="text" name="contact_number" value='<?php echo $contact_number; ?>' ></td>
                </tr>
                <tr >
                    <td>Email Address</td>
                    <td colspan="2"> <input type="text" name="email_address" value='<?php echo $email_address; ?>' ></td>
                </tr>
                <tr >
                    <td> Birthday </td>
                    <td colspan="2"> <input type="date" name="birthday" value='<?php echo $birthday; ?>' ></td>
                </tr>
                <tr >
                    <td> Religion</td>
                    <td colspan="2"> <input type="text" name="religion" value='<?php echo $religion; ?>' ></td>
                </tr>
                <tr >
                    <td> Permanent Address</td>
                    <td colspan="2"> <input type="text" name="address" value='<?php echo $address; ?>' ></td>
                </tr>
                <tr>
                    <td>
                        Weight <input type="text" name="weight" value='<?php echo $weight; ?>' >
                    </td>
                    <td colspan='2' > TIN Number <input type="text" name="tin_number" value='<?php echo $tin_number; ?>'  ></td>
                    <td colspan='2' width="30%"> PAG-IBIG Number <input type="text" name="pagibig_number" value='<?php echo $pagibig_number; ?>' ></td>
                </tr>
                <tr>
                    <td>
                        Height <input type="text" name="height" value='<?php echo $height; ?>' >
                    </td>
                    <td colspan='2' > SSS Number <input type="text" name="sss_number" value='<?php echo $sss_number; ?>'  ></td>
                    <td colspan='2' width="30%"> PhilHealth Number <input type="text" name="philhealth_number" value='<?php echo $philhealth_number; ?>'  ></td>
                </tr>
                <tr>
                    <td rowspan="7">
                        Civil Status: 
                        <input type="text" name='civil_status' value='<?php echo $civil_status; ?>' >
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                         <input type="text" name="spouse_name" value='<?php echo $spouse_name; ?>' >
                    </td>
                </tr>
                <tr>
                    <td >
                    ...
                    <td colspan="2">
                         <input type="date" name="spouse_birthday" value='<?php echo $spouse_birthday; ?>' >
                    </td>
                </tr>
                <tr>
                    <td >
                    ...
                    <td colspan="2">
                         <input type="text" name="spouse_number" value='<?php echo $spouse_number; ?>' >
                    </td>
                </tr>
                <tr>
                    <td >
                    ...
                    <td colspan="2">
                         <input type="text" name="spouse_email" value='<?php echo $spouse_email; ?>' >
                    </td>
                </tr>
                <tr>
                    <td >
                    ...
                    <td colspan="2">
                         <input type="text" name="spouse_occupation" value='<?php echo $spouse_occupation; ?>' >
                    </td>
                </tr>
                <tr>
                    <td >
                ...
                <tr>
                    <td> Address </td>
                    <td colspan='3'>
                        <input type="text" name="elementary_address" value='<?php echo $elementary_address; ?>' >
                    </td>
                </tr>
                <tr>
                    <td> Year Graduated </td>
                    <td colspan='3'>
                        <input type="text" name="elementary_graduate_year" value='<?php echo $elementary_graduate_year; ?>' >
                    </td>
                </tr>
                ...
                <tr>
                    <td> Address </td>
                    <td colspan='3'>
                        <input type="text" name="secondary_address" value='<?php echo $secondary_address; ?>' >
                    </td>
                </tr>
                <tr>
                    <td> Year Graduated </td>
                    <td colspan='3'>
                        <input type="text" name="secondary_graduate_year" value='<?php echo $secondary_graduate_year; ?>' >
                    </td>
                </tr>
                ...
                <tr>
                    <td> Address </td>
                    <td colspan='3'>
                        <input type="text" name="tertiary_address" value='<?php echo $tertiary_address; ?>' >
                    </td>
                </tr>
                <tr>
                    <td> Course </td>
                ...
                <tr>
                    <td> Year Graduated </td>
                    <td colspan='3'>
                        <input type="text" name="tertiary_graduate_year" value='<?php echo $tertiary_graduate_year; ?>' >
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan = '2'> Name <input type="text" name="emergency_name" value='<?php echo $emergency_name; ?>' > </td>
                    <td colspan = '2'> Address <input type="text" name="emergency_address" value='<?php echo $emergency_address; ?>' > </td>
                </tr>
                <tr>
                    <td colspan = '2'> Relationship <input type="text" name="emergency_relationship" value='<?php echo $emergency_relationship; ?>' > </td>
                    <td colspan = '2'> Contact Number <input type="text" name="emergency_number" value='<?php echo $emergency_number; ?>' > </td>
                </tr>
