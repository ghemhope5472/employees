...
?>
   ...
   <div class="container">
            <button class="btn btn-info" id="downloadPDF" style="margin-left: 8rem;margin-bottom:1rem;">Download PDF</button>
            <div id="content2" style="background: #fff;border-bottom: 1px solid #ffffff;">
                
                <div class="tokenDet"
                    style="padding: 15px;border: 1px solid black;width: 80%;margin: 0 auto;position: relative;overflow: hidden;">
                    <div class="header">
                    ...
                    <table>
                        <tr>
                            <td style='text-align:center;font-weight:bold;background-color: black;color:floralwhite;' colspan="4"> EMPLOYEE INFORMATION </td>
                        </tr>
                        <tr>
                            <td colspan='5'>
                        ...
                        <tr>
                            ...
                            <td> Position: <br> <input type="text" name="position" id="position" class="form-control" value='<?php echo $position; ?>' readonly></td>
                            <td> Employee Status: 
                        ...
                        <tr>
                            ...
                            <td colspan='3' style='text-align:center;font-weight:bold;background-color: black;color:floralwhite;'>
                        ...
                        <tr colspan="3">
                            <td> Family Name </td>
                            <td colspan="2"> <input type="text" id="fam_name" name="family_name" value='<?php echo $family_name; ?>' readonly></td>
                        </tr>
                        <tr >
                            <td> First Name </td>
                        ...
                        <tr>
                            <td colspan = '5' style='text-align:center;font-weight:bold;background-color: black;color:floralwhite;'> EDUCATIONAL BACKGROUND </td>
                        </tr>
                        <tr>
                            <td> Elementary </td>
                            <td colspan='3'>
                        ...
                        <tr >
                            <td  colspan = '5' style='text-align:center;font-weight:bold;background-color: black;color:floralwhite;'>
...
$('#downloadPDF').click(function () {
    var filename = document.getElementById('fam_name').value;
    ...
    var options = {
  	...
  	var pdf = new jsPDF('p', 'pt', 'a4');
  	    pdf.addHTML($("#content2"), 1, 10, options, function() {
